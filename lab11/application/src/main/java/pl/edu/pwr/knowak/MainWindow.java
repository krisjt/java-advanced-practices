...
public class MainWindow {
    ...
    public void createMainWindow(String alias, String password) throws IOException {
        ...
        boolean isJava9 = javaVersion.startsWith("9");
        ...
        radioButton2 = new JRadioButton(isJava9 ? "SymmetricKey - AES" : "SymmetricKey");
            ...
            try {
                if (radioButton1.isSelected()) {
                    ...
                    Encryptor.encryptFile(publicKey,
                            Paths.get(filePathField.getText()),
                            Paths.get(outputFilePathField.getText()));
                } else {
        ...
        decryptButton.addActionListener(e -> {
            ...
            try {
                if (radioButton1.isSelected()) {
                    ...
                    Decryptor.decryptionFile(privateKey, Paths.get(filePathField.getText()));
                } else {
                    secretKey = chachaHandler.loadKey(keyPassword.toCharArray(), keyAlias);
                    Decryptor.decryptChaChaFile(secretKey, Paths.get(filePathField.getText()));
                }
